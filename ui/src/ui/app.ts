...
import type { ToolApprovalRequest } from "./controllers/tool-approval.ts";
import type { GatewayBrowserClient, GatewayHelloOk } from "./gateway.ts";
import type { Tab } from "./navigation.ts";
import type { SplitPaneLayout, SplitDirection } from "./split-tree.ts";
...
import { loadThreadDescriptors, saveThreadDescriptors } from "./thread-storage.ts";
import {
  type ChatAttachment,
  type ChatQueueItem,
  type CronFormState,
...
export class OpenClawApp extends LitElement {
  ...
  // Usage / cost tracking (upstream addition)
  ...
  @state() usageSessionSort: "tokens" | "cost" | "name" | "time" = "tokens";
  @state() usageSessionSortDir: "asc" | "desc" = "desc";
  @state() usageRecentSessions: string[] = [];
  @state() usageTimeZone = Intl.DateTimeFormat().resolvedOptions().timeZone;
  @state() usageContextExpanded = false;
  @state() usageHeaderPinned = false;
  @state() usageSessionsTab: "breakdown" | "timeline" | "logs" = "breakdown";
  ...
  @state() usageLogFilterRoles: string[] = [];
