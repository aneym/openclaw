...
export function createThreadDescriptor(parentSessionKey: string, label?: string): ThreadDescriptor {
...
export function snapshotThreadState(
  host: SnapshotHost,
): Omit<ThreadState, "descriptor" | "unreadCount" | "hasNewMessages"> {
  return {
