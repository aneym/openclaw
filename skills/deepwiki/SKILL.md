...
```bash
node ./scripts/deepwiki.cjs ask <owner/repo> "your question"
```
...
```bash
node ./scripts/deepwiki.cjs structure <owner/repo>
```
...
```bash
node ./scripts/deepwiki.cjs contents <owner/repo> <path>
```
...
```bash
node ./scripts/deepwiki.cjs ask cognitionlabs/devin "How do I use MCP?"
```

**Get the structure for the React docs:**

```bash
node ./scripts/deepwiki.cjs structure facebook/react
```
