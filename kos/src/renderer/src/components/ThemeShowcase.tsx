      ...
      <div className="max-w-5xl mx-auto p-8 space-y-12">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            All installed shadcn/ui components with the current theme.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-3">
            {['Sidebar', 'Sidebar Primary', 'Sidebar Accent', 'Sidebar Border'].map((name) => {
              const key = name.toLowerCase().replace(/ /g, '-')
              return (
                <div
                  key={name}
                  className="rounded-lg p-4 text-sm font-medium border"
                  style={{ backgroundColor: `var(--${key})`, color: `var(--${key}-foreground, var(--foreground))` }}
                >
                  {name}
                </div>
              )
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  This is the card body content. It demonstrates how text and spacing look within a card.
                </p>
              </CardContent>
              ...
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="proveit">Prove It</SelectItem>
          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="overview" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>High-level project summary.</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="analytics" className="mt-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">Charts and metrics would go here.</p>
                </CardContent>
              </Card>
            </TabsContent>
        ...
        <section className="space-y-4">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                kOS is an AI-native workspace built on OpenClaw. It's general-purpose — anyone at Kinetic can use it, not just developers.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>How does auto-sort work?</AccordionTrigger>
              <AccordionContent>
                After the first message, the agent silently assigns the thread to a project using memory and conversation history. No prompting required.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>What about panel persistence?</AccordionTrigger>
              <AccordionContent>
                Panels appear adaptively based on activity but layout persists per thread. Come back later and the same layout is there.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">Small text — Captions and fine print.</p>
